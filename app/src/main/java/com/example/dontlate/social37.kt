...
class social37 : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dltBtn = findViewById(R.id.s33_dlt_btn)
        ...
        userDbManager = userDBManager(this@social37, "user_info", null, 1)
        var cursor : Cursor
        ...
        serverDBManager = serverDBManager(this@social37, "server", null, 1)
    ...
    internal inner class NextClickListener : View.OnClickListener {
        override fun onClick(v: View) {
            ...
            Toast.makeText(this@social37, "신청되었습니다.", Toast.LENGTH_SHORT).show()
